...
const SearchBar = () => {
  ...
  return (
    <div className="bg-slate-50 rounded-full flex place-items-center mt-3
   border-2 focus:border-2 focus:outline-double h-10 shadow-slate-700">
    ...
    className='border-none bg-transparent focus:outline-none focus:border-none flex items-center justify-center h-10 px-2 py-2'>
      ...
      <button type="submit" className="px-10 py-10
